...
public class ReloadedCriterionProgress {
  ...
  public ReloadedCriterionProgress(final AdvancementNode advancementNode, final AdvancementProgress progress,
    ...
    this.criterion = sanitizeIdentifierString(criterionName);
  ...
  private String getAdvancementIdentifier() {
    ...
    final Identifier locationId = this.getIdentifier();
  ...
  /**
   * Safely creates am Identifier from the given string.
   * <p>
   * Attempts to parse the provided string into a valid Identifier. If
   ...
   * A "ghost" Identifier is then created with the sanitized string using
   * the "minecraft" namespace.
   * </p>
   *
   * @param str the string to parse into a Identifier
   * @return a valid Identifier object
   */
  private static Identifier sanitizeIdentifierString(String str) {
